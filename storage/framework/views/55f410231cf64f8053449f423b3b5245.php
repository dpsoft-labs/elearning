<?php $__env->startSection('title'); ?>
    ...
    <?php endif; ?> <?php echo app('translator')->get('l.Users'); ?>
            ...
            <?php if($inactiveUsers == 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add users')): ?>
                    <div class="card-action-element mb-2" style="text-align: end; ">
                        <a href="<?php echo e(route('dashboard.admins.users-import-get')); ?>" class="btn btn-info waves-effect waves-light me-2">
                            <i class="fa fa-file-import ti-xs me-1"></i>
                            <?php echo app('translator')->get('l.Import Users'); ?>
                        </a>
                        <a href="<?php echo e(route('dashboard.admins.users-add')); ?>" class="btn btn-primary waves-effect waves-light"><i
                                class="fa fa-plus ti-xs me-1"></i>
                            <?php echo app('translator')->get('l.Add New User'); ?>
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete users')): ?>
                    <div class="card-action-element mb-2" style="text-align: end; ">
                        <a href="javascript:void(0);" class="btn btn-danger waves-effect waves-light delete-all-inactive"><i
                                class="fa fa-trash ti-xs me-1"></i><?php echo app('translator')->get('l.Delete All Inactive Users'); ?>
                        </a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
                ...
                <ul class="nav nav-tabs nav-fill w-100" role="tablist" style="min-height: 50px;">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($inactiveUsers == 0 ? 'active' : ''); ?>"
                            href="<?php echo e(route('dashboard.admins.users')); ?>" style="padding: 15px;">
                            <i class="fa fa-users ti-xs me-1"></i> <?php echo app('translator')->get('l.Active Users'); ?>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($inactiveUsers == 1 ? 'active' : ''); ?>"
                            href="<?php echo e(route('dashboard.admins.users')); ?>?inactive=1" style="padding: 15px;">
                            <i class="fa fa-user-times ti-xs me-1"></i> <?php echo app('translator')->get('l.Inactive Users'); ?>
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <table class="table" id="users-table">
                        <thead>
                            <tr>
                                ...
                                <th>#</th>
                                <th><?php echo app('translator')->get('l.User Name'); ?></th>
                                <th><?php echo app('translator')->get('l.Email'); ?></th>
                                <th><?php echo app('translator')->get('l.Phone'); ?></th>
                                <th><?php echo app('translator')->get('l.Role'); ?></th>
        ...
        $(function() {
                ...
                buttons: [{
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, node, config) {
                                    e.preventDefault();
                                    window.open(
                                        '<?php echo e(route('dashboard.admins.users.export')); ?>?type=excel&' +
                                        $.param({
                                            search: {
                                                value: table.search()
                                            },
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    e.preventDefault();
                                    window.open(
                                        '<?php echo e(route('dashboard.admins.users.export')); ?>?type=csv&' +
                                        $.param({
                                            search: {
                                                value: table.search()
                                            },
            ...
            function exportData(type) {
                if (type === 'print' || type === 'pdf') {
                    $.ajax({
                        url: '<?php echo e(route('dashboard.admins.users.export')); ?>',
                        type: 'GET',
                        data: {
                            search: {
                                value: table.search()
            ...
            <html dir="<?php echo e(in_array(app()->getLocale(), ['ar', 'he', 'fa', 'ur']) ? 'rtl' : 'ltr'); ?>" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
                <head>
                    <title><?php echo app('translator')->get('l.Users List'); ?></title>
                    <style>
                ...
                <body>
                    <h1><?php echo app('translator')->get('l.Users List'); ?></h1>
                    <table>
                        <thead>
        ...
        `;
            ...
            $(document).on('click', '.delete-record', function(e) {
                ...
                Swal.fire({
                    ...
                    text: isInactive ? "<?php echo app('translator')->get('l.The user will be deleted permanently!'); ?>" : "<?php echo app('translator')->get('l.The user will be disabled!'); ?>",
                    icon: 'warning',
            ...
            $('.delete-all-inactive').on('click', function(e) {
                ...
                Swal.fire({
                    title: '<?php echo app('translator')->get('l.Are you sure?'); ?>',
                    text: "<?php echo app('translator')->get('l.All inactive users will be deleted permanently! This action cannot be undone.'); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href =
                            '<?php echo e(route('dashboard.admins.users-delete-allinactive')); ?>';
                    }
                });
            });
            ...
            $('#deleteSelected').on('click', function() {
                ...
                if (selectedIds.length > 0) {
                    Swal.fire({
                        title: '<?php echo app('translator')->get('l.Are you sure?'); ?>',
                        text: "<?php echo app('translator')->get('l.Selected users will be deleted!'); ?>",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                        ...
                        if (result.isConfirmed) {
                            window.location.href =
                                '<?php echo e(route('dashboard.admins.users-delete-selected')); ?>?ids=' +
                                selectedIds.join(',');
                        }
                    });
                }
...
<?php echo $__env->make('themes.default.layouts.back.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/back/admins/users/users-list.blade.php ENDPATH**/ ?>