                ...
                <div class="row g-0">
                    ...
                    <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
                        <div
                            ...
                            <div class="avatar avatar-xl avatar-online chat-sidebar-avatar">
                                <img src="<?php echo e(asset(auth()->user()->photo)); ?>" alt="Avatar" class="rounded-circle">
                            </div>
                            <h5 class="mt-4 mb-0"><?php echo e(auth()->user()->firstname . ' ' . auth()->user()->lastname); ?></h5>
                        ...
                        <div class="sidebar-body ps ps--active-y">
                            ...
                            <ul class="list-unstyled chat-contact-list py-2 mb-0" id="chat-list">
                                <li class="chat-contact-list-item chat-contact-list-item-title mt-0">
                                    <h5 class="text-primary mb-0"><?php echo app('translator')->get('l.Previous User Chats'); ?></h5>
                                </li>
                                <?php $__empty_1 = true; $__currentLoopData = $ticket->user->tickets()->orderByDesc('id')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="chat-contact-list-item mb-1 <?php if($ticket->id == $tic->id): ?> active <?php endif; ?>">
                                        <a href="<?php echo e(route('dashboard.admins.tickets-show', ['id' => encrypt($tic->id)])); ?>"
                                            class="d-flex align-items-center text-secondary">
                                            <div
                                                class="flex-shrink-0 avatar <?php if($tic->status == 'answered'): ?> avatar-info <?php elseif($tic->status == 'in_progress'): ?> avatar-warning blink <?php else: ?> avatar-offline <?php endif; ?>">
                                    ...
                                    <div class="d-flex overflow-hidden align-items-center">
                                        ...
                                        <div class="chat-contact-info flex-grow-1 ms-4">
                                            <h6 class="m-0 fw-normal">
                                                <?php echo e($ticket->user->firstname . ' ' . $ticket->user->lastname); ?></h6>
                                            <small class="user-status text-body"><?php echo e($ticket->user->email); ?></small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown">
                                            <button class="btn btn-icon text-secondary dropdown-toggle hide-arrow" style="position: relative;"
                                                ...
                                                <?php if($ticket->status != 'closed'): ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit tickets')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('dashboard.admins.tickets-close')); ?>?id=<?php echo e(encrypt($ticket->id)); ?>">
                                                            <i class="fa fa-window-close me-md-1 me-0"></i> <?php echo app('translator')->get('l.Close Ticket'); ?>
                                                        </a>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit tickets')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('dashboard.admins.tickets-active')); ?>?id=<?php echo e(encrypt($ticket->id)); ?>">
                                                            <i class="fa fa-bolt me-md-1 me-0"></i> <?php echo app('translator')->get('l.Active Ticket'); ?>
                                                        </a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete tickets')): ?>
                                                    <a class="dropdown-item deleteTicket" href="javascript:void(0);"
                                                        data-delete-id="<?php echo e(encrypt($ticket->id)); ?>">
                                                        <i class="fa fa-trash me-md-1 me-0"></i> <?php echo app('translator')->get('l.Delete Ticket'); ?>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <?php if($ticket->status != 'closed'): ?>
                                <div class="chat-history-footer shadow-xs">
                                    <form class="d-flex justify-content-between align-items-center"
                                        method="post" action="<?php echo e(route('dashboard.admins.tickets-reply')); ?>"
                                        enctype="multipart/form-data" id="chatForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="ticket_id" value="<?php echo e($ticket->id); ?>">
                                        <input type="hidden" name="audio_message" id="audio_message">
                                        <textarea name="message" class="form-control message-input border-0 me-4 shadow-none" autofocus
                                            placeholder="<?php echo app('translator')->get('l.Type your message here...'); ?>" id="messageInput" required></textarea>
                    ...
                    <div class="col app-chat-sidebar-right app-sidebar overflow-hidden" id="app-chat-sidebar-right">
                        <div
                            ...
                            <div
                                class="avatar avatar-xl <?php if($ticket->user->isOnline()): ?> avatar-online <?php else: ?> avatar-offline <?php endif; ?> chat-sidebar-avatar">
                                <img src="<?php echo e(asset($ticket->user->photo)); ?>" alt="Avatar" class="rounded-circle">
                            </div>
                            <h5 class="mt-4 mb-0"><?php echo e($ticket->user->firstname . ' ' . $ticket->user->lastname); ?></h5>
                            <span><?php echo e($ticket->user->email); ?></span>
                        ...
                        <div class="sidebar-body p-6 pt-0 ps ps--active-y">
                            <div class="my-6">
                                <p class="text-uppercase mb-1 text-muted"><?php echo app('translator')->get('l.Client Information'); ?></p>
                                <ul class="list-unstyled d-grid gap-4 mb-0 ms-2 py-2 text-heading">
                                    <li class="d-flex align-items-center">
                                        <i class="bx bx-envelope"></i>
                                        <span class="align-middle ms-2"><?php echo e($ticket->user->email); ?></span>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i class="bx bx-phone-call"></i>
                                        <span class="align-middle ms-2"><?php echo e($ticket->user->phone); ?></span>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i class="bx bx-time-five"></i>
                                        <span
                                            class="align-middle ms-2"><?php echo e($ticket->user->created_at->format('d/m/Y')); ?></span>
                                    </li>
                                </ul>
                            </div>
                            <div class="d-flex mt-6">
                                <a href="<?php echo e(route('dashboard.admins.users-show')); ?>?id=<?php echo e(encrypt($ticket->user_id)); ?>"
                                    class="btn btn-info w-100">
                                    <?php echo app('translator')->get('l.Show Client'); ?> <i class="bx bx-show bx-sm ms-2"></i>
                                </a>
                            </div>
                            <div class="ps__rail-x" style="left: 0px; bottom: 0px;">
                                <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                            </div>
                            <div class="ps__rail-y" style="top: 0px; height: 354px; right: 0px;">
                                <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 213px;"></div>
                            </div>
                        </div>
                    </div>
                    <!-- /Sidebar Right -->
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        $(document).on('click', '.deleteTicket', function(e) {
            var inactiveId = $(this).data('delete-id'); // استرجاع معرّف الدور
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?php echo e(route('dashboard.admins.tickets-delete')); ?>?id=' +
                        inactiveId;
                }
            });
        });
    ...
    <script>
        ...
        function checkNewMessages() {
            $.ajax({
                url: '<?php echo e(route("dashboard.admins.tickets-get-new-messages")); ?>',
                method: 'GET',
                data: {
                            ...
                            audioElement.addEventListener('timeupdate', function() {
                                ...
                                waveBars.forEach((bar, index) => {
                                    ...
                                    if (barIndex < progressPercent) {
                                        ...
                                        bar.style.backgroundColor = '<?php echo e($settings['primary_color']); ?>';
                                    }
                                });
...
<?php echo $__env->make('themes.default.layouts.back.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/back/admins/tickets/tickets-show.blade.php ENDPATH**/ ?>