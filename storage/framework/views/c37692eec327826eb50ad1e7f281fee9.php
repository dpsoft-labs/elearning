...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>"
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/themes/default/vendor/libs/typeahead-js/typeahead.css')); ?>" />
        <!-- Vendor -->
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/themes/default/vendor/libs/bs-stepper/bs-stepper.css')); ?>" />
        <link rel="stylesheet"
        ...
        <link rel="stylesheet"
            href="<?php echo e(asset('assets/themes/default/vendor/libs/@form-validation/form-validation.css')); ?>" />

        <!-- Page CSS -->
        <!-- Page -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/themes/default/vendor/css/pages/page-auth.css')); ?>" />
    ...
    <body>
        ...
        <div class="authentication-wrapper authentication-cover <?php echo $__env->yieldContent('wrapper-class'); ?>">
            <!-- Logo -->
            <a href="<?php echo e(route('index')); ?>" class="app-brand auth-cover-brand gap-2">
                <span class="app-brand-logo demo">
                    <?php if($settings['logo'] && file_exists(public_path($settings['logo']))): ?>
                        <img id="app-logo" src="<?php echo e(asset($settings['logo'])); ?>" alt="<?php echo e($settings['name']); ?>"
                            width="150" />
                    <?php else: ?>
                        <svg width="50" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- Vendors JS -->
        <script src="<?php echo e(asset('assets/themes/default/vendor/libs/cleavejs/cleave.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/themes/default/vendor/libs/cleavejs/cleave-phone.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/themes/default/vendor/libs/bs-stepper/bs-stepper.js')); ?>"></script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // قراءة قيمة الثيم من الـ localStorage
                var theme = localStorage.getItem('templateCustomizer-vertical-menu-template--Theme');
                var logo = "<?php echo e($settings['logo']); ?>";
                var logo_dark = "<?php echo e($settings['logo_black']); ?>";
                ...
                if (!theme) {
                    ...
                    if (theme === 'light') {
                        ...
                        logo = (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) ?
                            logo : logo_dark;
                    } else {
                        logo = logo;
                    }
                ...
                // تحديث مصدر صورة الشعار إذا كانت موجودة كعنصر <img>
                var logoImg = document.getElementById('app-logo');
                if (logoImg) {
                    // تأكد من ضبط مسار الصور حسب هيكلة مشروعك
                    logoImg.src = "<?php echo e(asset('/')); ?>/" + '/' + logo;
                }
            });
        </script>
    </body>
...
<?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/auth/layout.blade.php ENDPATH**/ ?>