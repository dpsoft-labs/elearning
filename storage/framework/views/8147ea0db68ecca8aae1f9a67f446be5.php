...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show branches')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add branches')): ?>
                <div class="card-action-element mb-2" style="text-align: end;">
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                        data-bs-target="#addBranchModal">
                        <i class="fa fa-plus fa-xs me-1"></i> <?php echo e(__('l.Add New Branch')); ?>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content p-3 p-md-5">
                            <div class="modal-header">
                                <h3 class="modal-title text-center"><?php echo e(__('l.Add New Branch')); ?></h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form id="addBranchForm" class="row g-3" method="post"
                                    action="<?php echo e(route('dashboard.admins.branches-store')); ?>">
                                    <?php echo csrf_field(); ?>
                    ...
                    <table class="table" id="branches-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <input type="checkbox" class="form-check-input row-checkbox" value="<?php echo e($branch->id); ?>">
                                    </td>
                                    ...
                                    <td><?php echo e($branch->students->count()); ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show branches')): ?>
                                                <a href="<?php echo e(route('dashboard.admins.branches-show', ['id' => encrypt($branch->id)])); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit branches')): ?>
                                                <a href="<?php echo e(route('dashboard.admins.branches-edit', ['id' => encrypt($branch->id)])); ?>"
                                                   class="btn btn-sm btn-primary me-1" title="<?php echo e(__('l.Edit')); ?>">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete branches')): ?>
                                                <button type="button" class="btn btn-sm btn-danger delete-branch"
                                                        data-id="<?php echo e(encrypt($branch->id)); ?>" title="<?php echo e(__('l.Delete')); ?>">
        ...
        $(function() {
            ...
            $('#deleteSelected').on('click', function() {
                ...
                if (selectedIds.length > 0) {
                    Swal.fire({
                        ...
                        text: "<?php echo e(__('l.Selected branches will be deleted!')); ?>",
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            window.location.href =
                                "<?php echo e(route('dashboard.admins.branches-deleteSelected')); ?>?ids=" +
                                selectedIds.join(',');
                        }
                    });
                }
            ...
            $(document).on('click', '.delete-branch', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href =
                            "<?php echo e(route('dashboard.admins.branches-delete')); ?>?id=" +
                            branchId;
                    }
                });
            });
...
<?php echo $__env->make('themes.default.layouts.back.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/back/admins/branches/branches-list.blade.php ENDPATH**/ ?>