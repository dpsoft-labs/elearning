                ...
                <div class="modal-content p-3 p-md-5">
                    ...
                    <div class="modal-body">
                        <form id="addTicketForm" class="row g-3" method="post"
                            action="<?php echo e(route('dashboard.admins.notes-store')); ?>">
                            <?php echo csrf_field(); ?>
        ...
        $(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href =
                                '<?php echo e(route('dashboard.admins.notes-deleteSelected')); ?>?ids=' +
                                selectedIds.join(',');
                        }
                    });
                }
            ...
            $(document).on('click', '.delete-note', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '<?php echo e(route('dashboard.admins.notes-delete')); ?>?id=' +
                            noteId;
                    }
                });
            });
...
<?php echo $__env->make('themes.default.layouts.back.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/back/admins/notes/notes-list.blade.php ENDPATH**/ ?>