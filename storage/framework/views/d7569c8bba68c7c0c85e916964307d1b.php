                    ...
                    <tbody>
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <a
                                        href="<?php echo e(route('dashboard.users.invoices-show', ['invoice_id' => encrypt($invoice->id)])); ?>">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="<?php echo e(route('dashboard.users.invoices-show', ['invoice_id' => encrypt($invoice->id)])); ?>"
...
<?php echo $__env->make('themes.default.layouts.back.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\pending\eelu\resources\views/themes/default/back/users/invoices/invoices-list.blade.php ENDPATH**/ ?>