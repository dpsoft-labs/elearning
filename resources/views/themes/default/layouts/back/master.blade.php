...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="layout-navbar-fixed layout-menu-fixed layout-compact"
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/themes/default/vendor/libs/apex-charts/apex-charts.css') }}" />
        ...
        <link rel="stylesheet" href="{{ asset('assets/themes/default/vendor/libs/typeahead-js/typeahead.css') }}" />

        <!-- SweetAlert2 -->
        <link rel="stylesheet" href="{{ asset('assets/themes/default/vendor/libs/animate-css/animate.css') }}" />
        <link rel="stylesheet" href="{{ asset('assets/themes/default/vendor/libs/sweetalert2/sweetalert2.css') }}" />
                        ...
                        @if (auth()->user()->hasRole('demo'))
                            <div class="container mt-3">
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    @lang('l.Demo Account Notice: This is a demo account with limited functionality. You cannot make any modifications, and many features are restricted or unavailable.')
                                            ...
                                            <div>
                                                <a href="{{ route('impersonate.leave') }}"
                                                    class="btn btn-sm btn-outline-danger"><i
                                                        class="bx bx-door-open me-1"></i>@lang('l.Leave')</a>
                                            </div>
                                        </div>
                                    </footer>
                                </section>
