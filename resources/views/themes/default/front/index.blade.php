...
@section('content')
    ...
    <section id="hero-animation">
        <div id="landingHero" class="section-py landing-hero position-relative">
            <img src="{{ asset('assets/themes/default/img/front-pages/backgrounds/hero-bg.png') }}" alt="hero background"
                class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100 h-100" data-speed="1" />
            <div class="container">
                <div class="hero-text-box text-center position-relative">
                    <h1 class="text-primary hero-title display-6 fw-extrabold">
                        @lang('front.One place to manage all your businesses')
                    </h1>
                    <h2 class="hero-sub-title h6 mb-6">
                        @lang('front.Production-ready & easy to use Our System')<br class="d-none d-lg-block" />
                        @lang('front.for Reliability and Customizability').
                    </h2>
                    <div class="landing-hero-btn d-inline-block position-relative">
                        <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">@lang('front.Join now')
                            <img src="{{ asset('assets/themes/default/img/front-pages/icons/Join-community-arrow.png') }}"
                                alt="Join community arrow" class="scaleX-n1-rtl" /></span>
                        <a href="#landingPricing" class="btn btn-primary btn-lg">@lang('front.Get early access')</a>
                    </div>
                </div>
                <div id="heroDashboardAnimation" class="hero-animation-img">
                    <a href="#">
                        <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                            <img src="{{ asset('assets/themes/default/img/front-pages/landing-page/hero-dashboard-light.png') }}"
                                alt="hero dashboard" class="animation-img"
                                data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                                data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
                            <img src="{{ asset('assets/themes/default/img/front-pages/landing-page/hero-elements-light.png') }}"
    ...
    <section id="about" class="section-py landing-features">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary"> @lang('front.Useful Features')</span>
            </div>
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1"> @lang('front.Everything you need')
                    <img src="{{ asset('assets/themes/default/img/front-pages/icons/section-title-icon.png') }}"
                        alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
                 @lang('front.to start your next project')
            </h4>
            <p class="text-center mb-12">
                 @lang('front.Not just a set of tools, the package includes ready-to-deploy conceptual application').
            </p>
            <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"> @lang('front.Quality Code')</h5>
                    <p class="features-icon-description">
                         @lang('front.Code structure that all developers will easily understand and fall in love with').
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    <div class="mb-4 text-primary text-center">
                    ...
                    <h5 class="mb-2"> @lang('front.Continuous Updates')</h5>
                    <p class="features-icon-description">
                         @lang('front.Free updates for the next 12 months, including new demos and features').
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    ...
                    <h5 class="mb-2"> @lang('front.Starter-Kit')</h5>
                    <p class="features-icon-description">
                         @lang('front.Start your project quickly without having to remove unnecessary features').
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    <div class="text-center mb-4 text-primary">
                    ...
                    <h5 class="mb-2"> @lang('front.API Ready')</h5>
                    <p class="features-icon-description">
                         @lang('front.Just change the endpoint and see your own data loaded within seconds').
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    <div class="text-center mb-4 text-primary">
                    ...
                    <h5 class="mb-2"> @lang('front.Excellent Support')</h5>
                    <p class="features-icon-description"> @lang('front.An easy-to-follow doc with lots of references and code examples').</p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                    <div class="text-center mb-4 text-primary">
                        <svg width="64" height="65" viewBox="0 0 64 65" fill="none"
                    ...
                    <h5 class="mb-2"> @lang('front.Well Documented')</h5>
                    <p class="features-icon-description"> @lang('front.An easy-to-follow doc with lots of references and code examples').</p>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="section-py landing-team">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary">@lang('front.Our Great Team')</span>
            </div>
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">@lang('front.Supported')
                    <img src="{{ asset('assets/themes/default/img/front-pages/icons/section-title-icon.png') }}"
                        alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
                @lang('front.by Real People')
            </h4>
            <p class="text-center mb-md-11 pb-0 pb-xl-12"> @lang('front.Who is behind these great-looking interfaces?')</p>
            <div class="row gy-12 mt-2">
                @foreach($team_members as $member)
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            @php $label = ['primary', 'info', 'danger', 'success'][$loop->index % 4]; @endphp
                            <div
                                class="bg-label-{{ $label }} border border-bottom-0 border-{{$label}}-subtle position-relative team-image-box">
                            ...
                            <div class="card-body border border-top-0 border-primary-subtle text-center py-5">
                                ...
                                <p class="text-body-secondary mb-0">{{$member->job}}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <section id="pricing" class="section-py bg-body landing-pricing">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary">@lang('front.subscription_packages')</span>
            </div>
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">@lang('front.custom_packages')
                    <img src="{{ asset('assets/themes/default/img/front-pages/icons/section-title-icon.png') }}"
                        alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
                @lang('front.for_educational_needs')
            </h4>
            <p class="text-center pb-2 mb-7">
                @lang('front.pricing_description')<br />@lang('front.choose_suitable_package')
            </p>
            <div class="text-center mb-12">
                <div class="position-relative d-inline-block pt-3 pt-md-0">
                    <label class="switch switch-sm switch-primary me-0">
                        <span class="switch-label fs-6 text-body me-3">@lang('front.monthly_payment')</span>
                        <input type="checkbox" class="switch-input price-duration-toggler" checked />
                        <span class="switch-toggle-slider">
                            <span class="switch-on"></span>
                            <span class="switch-off"></span>
                        </span>
                        <span class="switch-label fs-6 text-body ms-3">@lang('front.yearly_payment')</span>
                    </label>
                    <div class="pricing-plans-item position-absolute d-flex">
                        <img src="{{ asset('assets/themes/default/img/front-pages/icons/pricing-plans-arrow.png') }}"
                            alt="pricing plans arrow" class="scaleX-n1-rtl" />
                        <span class="fw-medium mt-2 ms-1">@lang('front.save_25')</span>
                    </div>
                </div>
            </div>
            <div class="row g-6 pt-lg-5">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-center">
                                <img src="{{ asset('assets/themes/default/img/front-pages/icons/paper-airplane.png') }}"
                                    alt="paper airplane icon" class="mb-8 pb-2" />
                                <h4 class="mb-0">@lang('front.teachers_package')</h4>
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <sub class="h6 text-body-secondary mb-n1 ms-1">@lang('front.per_month')</sub>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled pricing-list">
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        ...
                                        @lang('front.create_manage_courses')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                ...
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.student_communication')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.performance_analytics')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.basic_support')
                                    </h6>
                                </li>
                            </ul>
                            <div class="d-grid mt-8">
                                <a href="{{route('home')}}" class="btn btn-label-primary">@lang('front.start_now')</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card border border-primary shadow-xl">
                        <div class="card-header">
                            <div class="text-center">
                                <img src="{{ asset('assets/themes/default/img/front-pages/icons/plane.png') }}"
                                    alt="plane icon" class="mb-8 pb-2" />
                                <h4 class="mb-0">@lang('front.schools_package')</h4>
                                <div class="d-flex align-items-center justify-content-center">
                            ...
                            <ul class="list-unstyled pricing-list">
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.all_teachers_features')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.manage_teachers_students')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                ...
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.curriculum_management')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.premium_support')
                                    </h6>
                                </li>
                            </ul>
                            <div class="d-grid mt-8">
                                <a href="{{route('home')}}" class="btn btn-primary">@lang('front.start_now')</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="text-center">
                                <img src="{{ asset('assets/themes/default/img/front-pages/icons/shuttle-rocket.png') }}"
                                    alt="shuttle rocket icon" class="mb-8 pb-2" />
                                <h4 class="mb-0">@lang('front.universities_package')</h4>
                                <div class="d-flex align-items-center justify-content-center">
                            ...
                            <ul class="list-unstyled pricing-list">
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.all_schools_features')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.manage_colleges_departments')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.manage_students_staff')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.course_registration')
                                    </h6>
                                </li>
                                <li>
                                    <h6 class="d-flex align-items-center mb-3">
                                        <span class="badge badge-center rounded-pill bg-label-primary p-0 me-3"><i
                                                class="icon-base bx bx-check icon-12px"></i></span>
                                        @lang('front.university_admission_gpa')
                                    </h6>
                                </li>
                            </ul>
                            <div class="d-grid mt-8">
    ...
    <section id="faq" class="section-py bg-body landing-faq">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary">@lang('front.FAQ')</span>
            </div>
            <h4 class="text-center mb-1">
                @lang('front.Frequently asked')
                <span class="position-relative fw-extrabold z-1">@lang('front.questions')
                    <img src="{{ asset('assets/themes/default/img/front-pages/icons/section-title-icon.png') }}"
                        alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
            </h4>
            <p class="text-center mb-12 pb-md-4">
                @lang('front.Browse through these FAQs to find answers to commonly asked questions').
            </p>
            <div class="row gy-12 align-items-center">
                <div class="col-lg-5">
                    <div class="text-center">
                        <img src="{{ asset('assets/themes/default/img/front-pages/landing-page/faq-boy-with-logos.png') }}"
                            ...
                            <div class="card accordion-item {{ $loop->first ? 'active' : '' }}">
                                <h2 class="accordion-header" id="headingOne">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse"
                                        data-bs-target="#accordion{{ $loop->index }}" aria-expanded="true" aria-controls="accordion{{ $loop->index }}">
                                        {{ $question->question }}
                                    </button>
                                </h2>
    ...
    <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
        <img src="{{ asset('assets/themes/default/img/front-pages/backgrounds/cta-bg-light.png') }}"
        ...
        <div class="container">
            <div class="row align-items-center gy-12">
                <div class="col-lg-6 text-start text-sm-center text-lg-start">
                    <h3 class="cta-title text-primary fw-bold mb-1">@lang('front.ready_to_get_started')</h3>
                    <h5 class="text-body mb-8">@lang('front.start_project_trial')</h5>
                    <a href="{{route('home')}}" class="btn btn-lg btn-primary">@lang('front.get_started')</a>
                </div>
                <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                    <img src="{{ asset('assets/themes/default/img/front-pages/landing-page/cta-dashboard.png') }}"
    ...
    <section id="contact" class="section-py bg-body landing-contact">
        <div class="container">
            <div class="text-center mb-4">
                <span class="badge bg-label-primary">@lang('front.contact')</span>
            </div>
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">@lang('front.lets_work')
                    <img src="{{ asset('assets/themes/default/img/front-pages/icons/section-title-icon.png') }}"
                        alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
                @lang('front.together')
            </h4>
            <p class="text-center mb-12 pb-md-4">@lang('front.any_question')</p>
            <div class="row g-6">
                <div class="col-lg-5">
                    <div class="contact-img-box position-relative border p-2 h-100">
                        <img src="{{ asset('assets/themes/default/img/front-pages/icons/contact-border.png') }}"
                            alt="contact border" class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
                        <img src="{{ asset('assets/themes/default/img/front-pages/landing-page/contact-customer-service.png') }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0">@lang('front.email')</p>
                                            <h6 class="mb-0">
                                                <a href="mailto:{{ $settings['email1'] }}"
                                                    class="text-heading">{{ $settings['email1'] }}</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0">@lang('front.phone')</p>
                                            <h6 class="mb-0"><a href="tel:{{ $settings['phone1'] }}" class="text-heading">{{ $settings['phone1'] }}</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-7">
                    <div class="card h-100">
                        <div class="card-body">
                            <h4 class="mb-2">@lang('front.send_message')</h4>
                            <p class="mb-6">
                                @lang('front.contact_description')
                            </p>
                            <form action="{{ route('contact.store') }}" method="POST">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-fullname">@lang('front.full_name') <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="name" id="contact-form-fullname"
                                            placeholder="@lang('front.full_name')" value="{{ old('name') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-email">@lang('front.email') <span class="text-danger">*</span></label>
                                        <input type="text" id="contact-form-email" name="email" class="form-control"
                                            placeholder="@lang('front.your_email')" value="{{ old('email') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-phone">@lang('front.phone') <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="phone" id="contact-form-phone"
                                            placeholder="@lang('front.phone')" value="{{ old('phone') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="contact-form-subject">@lang('front.subject')</label>
                                        <input type="text" id="contact-form-subject" name="subject" class="form-control"
                                            placeholder="@lang('front.subject')" value="{{ old('subject') }}" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="contact-form-message">@lang('front.message') <span class="text-danger">*</span></label>
                                        <textarea id="contact-form-message" name="details" class="form-control" rows="11" placeholder="@lang('front.write_message')" value="{{ old('details') }}" required></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">@lang('front.send_inquiry')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
