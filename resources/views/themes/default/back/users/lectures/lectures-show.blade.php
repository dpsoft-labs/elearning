    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-12 col-lg-10 offset-lg-1">
                <!-- عنوان المحاضرة -->
                <h1 class="mb-4 text-center text-primary">{{ $lecture->name }}</h1>

                <!-- مشغل الفيديو -->
                <div class="video-container mb-4">
                    <div id="plyr-video-player" data-plyr-provider="youtube"
                        data-plyr-embed-id="{{ \Illuminate\Support\Str::after($lecture->video, 'v=') }}"
                        data-plyr-config='{
                ...
                @if (!empty($lecture->description))
                    <div class="description-section mb-4">
                        <h4 class="text-primary">@lang('l.Description'):</h4>
                ...
                @if (!empty($lecture->files))
                    <div class="download-section mb-4">
                        <h4 class="text-primary">@lang('l.Download File'):</h4>
                        <a href="{{ asset($lecture->files) }}" class="btn btn-outline-primary btn-lg" download>
                            <i class="fas fa-download"></i> @lang('l.Download Now')
                        </a>
                    </div>
                @endif
            </div>
