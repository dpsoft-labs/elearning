            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('dashboard.admins.registrations-show', ['student_id' => encrypt($student->id)]) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if(count($availableCourses) > 0)
                                <form id="register-form" action="{{ route('dashboard.admins.registrations-store') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="card course-card h-100">
                                                    <div class="card-header d-flex justify-content-between align-items-center bg-light">
                                                        @can('add registrations')
                                                            <div class="form-check">
                                                                <input type="checkbox" name="course_ids[]" class="form-check-input course-checkbox" value="{{ $course->id }}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <h6 class="mb-1">{{ __('l.Required Hours') }}: {{ $course->required_hours }}</h6>
