...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        @can('show colleges')
            <div class="row">
                <div class="col-12">
                    <h5 class="card-title">{{ __('l.College Details') }}</h5>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p>{{ $college->students->count() }}</p>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <h6>{{ __('l.Created At') }}</h6>
                                    <p>{{ $college->created_at->format('Y-m-d H:i') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{ __('l.Students in this College') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" id="students-table">
                                    ...
                                    <tbody>
                                        @foreach($college->students as $index => $student)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
