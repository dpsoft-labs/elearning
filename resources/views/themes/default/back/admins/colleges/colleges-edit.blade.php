...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        @can('edit colleges')
            <div class="row">
                <div class="col-12">
                    <h5 class="card-title">{{ __('l.Edit College') }}</h5>
                </div>

                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="mb-0">{{ __('l.College Information') }}</h5>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form class="row g-3" method="post"
                                  action="{{ route('dashboard.admins.colleges-update') }}">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('dashboard.admins.colleges') }}"
