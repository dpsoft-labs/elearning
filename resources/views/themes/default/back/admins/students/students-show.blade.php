...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">@lang('l.Student Account') /</span> {{ $user->firstname }}</h4>
        @can('show students')
            <div class="row">
                <div class="col-md-12">
                    <div id="page1">
