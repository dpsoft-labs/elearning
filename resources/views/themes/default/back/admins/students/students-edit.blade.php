...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">@lang('l.Student Account') /</span>
            {{ $user->firstname }}
        </h4>
        @can('edit students')
            <div class="row">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="formAccountSettings" method="POST"
                                    action="{{ route('dashboard.admins.students-update') }}"> @csrf @method('patch')
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label for="branch" class="form-label">@lang('l.Branch')</label>
                                            <select id="branch" class="select2 form-select" name="branch_id">
                                                <option value="">{{ __('l.Select Branch') }}</option>
                                            ...
                                            <x-input-error class="mt-2 error-message" :messages="$errors->get('branch_id')" />
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="college" class="form-label">@lang('l.College')</label>
                                            <select id="college" class="select2 form-select" name="college_id">
                                            ...
                                            <x-input-error class="mt-2 error-message" :messages="$errors->get('college_id')" />
                                        </div>
                                        <div class="mb-3 col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="formAccountDeactivation" method="get"
                                        action="{{ route('dashboard.admins.students-inactive') }}">@csrf
                        ...
                        <div class="card mb-4 mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <form id="formAccountSettings5" method="POST"
                                    action="{{ route('dashboard.admins.students-updatepassword') }}"> @csrf
                                    @method('put')
                                    <div class="row">
                                        ...
                                        <div class="card-body">
                                            <form id="formAccountSettingsApiKey" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="submit"
                                                            class="btn btn-secondary me-2 d-grid w-100">@lang('l.Assign')</button>
                                                    </div>
                                                </div>
                                            </form>
