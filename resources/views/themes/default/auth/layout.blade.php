...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    ...
    dir="{{ in_array(app()->getLocale(), ['ar', 'he', 'fa', 'ur']) ? 'rtl' : 'ltr' }}" data-theme="theme-default"
    ...
    <head>
        ...
        <!-- Vendor -->
        <link rel="stylesheet"
            href="{{ asset('assets/themes/default/vendor/libs/bs-stepper/bs-stepper.css') }}" />
        <link rel="stylesheet"
        ...
        <link rel="stylesheet"
            href="{{ asset('assets/themes/default/vendor/libs/@form-validation/form-validation.css') }}" />

        <!-- Page CSS -->
        <!-- Page -->
        <link rel="stylesheet" href="{{ asset('assets/themes/default/vendor/css/pages/page-auth.css') }}" />
    ...
    <body>
        ...
        <div class="authentication-wrapper authentication-cover @yield('wrapper-class')">
            <!-- Logo -->
            <a href="{{ route('index') }}" class="app-brand auth-cover-brand gap-2">
                <span class="app-brand-logo demo">
                    @if ($settings['logo'] && file_exists(public_path($settings['logo'])))
                        <img id="app-logo" src="{{ asset($settings['logo']) }}" alt="{{ $settings['name'] }}"
                            width="150" />
                    @else
                ...
                {{-- <span class="app-brand-text demo text-heading fw-bold">{{ $settings['name'] }}</span> --}}
            </a>
        ...
        <!-- Vendors JS -->
        <script src="{{ asset('assets/themes/default/vendor/libs/cleavejs/cleave.js') }}"></script>
        <script src="{{ asset('assets/themes/default/vendor/libs/cleavejs/cleave-phone.js') }}"></script>
        <script src="{{ asset('assets/themes/default/vendor/libs/bs-stepper/bs-stepper.js') }}"></script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var logo_dark = "{{ $settings['logo_black'] }}";
